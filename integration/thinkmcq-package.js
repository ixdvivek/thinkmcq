...
(function () {
  ...
  var selects = Array.prototype.slice.call(root.querySelectorAll('[data-exam-sync]'));
  var pillGroups = Array.prototype.slice.call(root.querySelectorAll('[data-exam-pills]'));
  ...
  var carousel = root.querySelector('#packageCarousel');
  var dots = Array.prototype.slice.call(root.querySelectorAll('#carDots .dot'));
  ...
  var revealables = Array.prototype.slice.call(root.querySelectorAll('.reveal'));
  ...
  root.querySelectorAll('.bento-item').forEach(function (card) {
  ...
  root.querySelectorAll('[data-video]').forEach(function (el) {
